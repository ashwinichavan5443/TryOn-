...
dress = cv2.imread("/home/hp/Downloads/dataset/dress(western)/cocktail/cocktail3.png", cv2.IMREAD_UNCHANGED)
bgr = dress[:,:,:3]
...
girl = cv2.imread("/home/hp/girl/testdataset/finalg.jpg")
...
for x, y, w, h in found:
    ...
    h=int(h/2)
    dress = cv2.resize(result, (w +Fw-150, h))
    ...
    for i in range(0, w):
        for j in range(0, h):
            ...
            if dress[i, j][3] != 0:
                girl[y + i+Fy-8, x + j-Fw+135] = dress[i, j]

...
dress = cv2.imread("/home/hp/Downloads/dataset/dress(western)/Formal/gown6.png", cv2.IMREAD_UNCHANGED)
bgr = dress[:,:,:3]
...
girl = cv2.imread("/home/hp/girl/testdataset/finalg2.jpg")
...
for x, y, w, h in found:
    ...
    dress = cv2.resize(result, (w +Fw-25, h))
    ...
    for i in range(0, w):
        for j in range(0, h):
            ...
            if dress[i, j][3] != 0:
                girl[y + i+Fy-10, x + j-Fw+53] = dress[i, j]
girl.save(filename="/home/hp/PycharmProjects/tryOn/images/result.png")

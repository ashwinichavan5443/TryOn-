...
dress = cv2.imread("/home/hp/Downloads/dataset/saree/saree3.png", cv2.IMREAD_UNCHANGED)
bgr = dress[:,:,:3]
...
for x, y, w, h in found:
    ...
    dress = cv2.resize(result, (w +Fw-65, h-Fy))
    ...
    for i in range(0, w):
        for j in range(0, h):
            ...
            if dress[i, j][3] != 0:
                girl[y + i+Fy-10, x + j-Fw+80] = dress[i, j]
